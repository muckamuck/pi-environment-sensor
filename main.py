...
def readBME280All(addr=DEVICE):
    ...
    temperature = temperature / 100.0 * 9 / 5 + 32
    pressure = pressure / 100.0 / 33.863
    return round(temperature, 1), round(pressure, 1), round(humidity, 1)
...
if __name__ == '__main__':
    ...
    logger.info('sleeping for a moment for the vacuum tubes to warm up')
    time.sleep(1)
